...
export const progInfoMeta = {
  rhc: {
    ...
    targetBuyer:
      'Research Institutes, Drug Manufacturers, Health "Care Teams", Private Health Insurance',
  ...
  gdc: {
    ...
    medium: "Telegram App",
    outcome:
      "Data produced from this app can be used to unlock valuable data; direct-from-gamers.",
  ...
  wfa: {
    ...
    outcome:
      'Data produced from this program is fully "normalised" and will be very valuable',
...
export const tmpProgIdMapping = {
  ...
  "183f0290-f726-11e7-9186-3bcb5c5d22db":
    "Chronic Wounds Healing Progress Tracker",
...
export const SUPPORTED_CHAINS = [
  31337, 3, 4, 80001, 97, 1666700000, 210309, 123, 43113,
];
...
export function noChainSupport(menuItem, networkId) {
  ...
  if (
    SUPPORTED_CHAINS.includes(networkId) &&
    UNSUPPORTED_CHAIN_FEATURES[networkId]
  ) {
...
export const buyOnOpenSea = (txNFTId, dnftContract, txNetworkId) => {
  ...
  console.log(txNetworkId);
  window.open(
    `https://testnets.opensea.io/assets/${OPENSEA_CHAIN_NAMES[txNetworkId]}/${dnftContract}/${txNFTId}`
  );
};
