...
export const historicGuardrails = [
  {
    id: "0",
    buyer_fee_oldPrice: "40",
    buyer_fee_newPrice: "60",
    date: "25/02/2024 14:39:50",
    seller_fee_oldPrice: "60",
    seller_fee_newPrice: "60",
...
export const upcomingGuardRails = {
  ...
  minimum_royalties: "0",
  maximum_royalties: "50",
  time_between_mints: "10",
  max_data_nft_supply: "10000",
  antiSpam_tax: "50",
  accepted_payments: "ITHEUM",
  accepted_tokens: "ITHEUM",
};
