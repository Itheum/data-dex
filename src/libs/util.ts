...
export const styleStrings = {
  ...
  gradientBorderPassive: "linear-gradient(bgDark, bgDark) padding-box, linear-gradient(to right, rgb(79 209 197 / 20%), rgb(79 209 197 / 60%)) border-box",
  ...
  gradientBorderMulticolorToBottomRight: "linear-gradient(bgDark, bgDark) padding-box, linear-gradient(to left top, #00C79750, #FF439D50) border-box",
