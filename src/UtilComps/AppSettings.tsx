...
import { getSentryProfile, getApiDataDex, getApiDataMarshal } from "../libs/util2";
          ...
          <Box maxW="sm" p="10" m="auto" borderRadius="lg" w="90%" maxWidth="initial">
            ...
            <Box>
              ...
              <Box fontSize="sm">
                ...
                <Text>Network Provider: {isPublicNetworkProvider ? "Public" : "Private"} {isApiNetworkProvider ? "API" : "Gateway"}</Text>
