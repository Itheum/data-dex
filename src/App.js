                  ...
                  >
                      ...
                      <AccordionPanel>
                        ...
                        >
                          ...
                          <Button
                            ...
                            onClick={() => setMenuItem(MENU.ADVERTISED)}
                          >
                            Advertised Data
                          </Button>
                          <Button
                            ...
                            onClick={() => setMenuItem(MENU.PURCHASED)}
                          >
                            Purchased Data
                          </Button>
                          <Button
                            ...
                            onClick={() => setMenuItem(MENU.DATAPROOFS)}
                          >
                      ...
                      <AccordionPanel>
                        ...
                        >
                          <Button
                            colorScheme="teal"
                            isDisabled={
                              menuItem === MENU.NFTMINE ||
                              noChainSupport(MENU.NFTMINE, chainMeta.networkId)
                            }
                            onClick={() => {
                          ...
                          <Button
                            colorScheme="teal"
                            isDisabled={
                              menuItem === MENU.NFTALL ||
                              noChainSupport(MENU.NFTALL, chainMeta.networkId)
                            }
                            onClick={() => {
                              if (splashScreenShown[MENU.NFT]) {
                    ...
                    <AccordionItem>
                      ...
                      <AccordionPanel>
                        ...
                        >
                          <Button
                            disabled={noChainSupport(
                              MENU.TX,
                              chainMeta.networkId
                            )}
                            colorScheme="teal"
                            isDisabled={menuItem === MENU.TX}
                            onClick={() => setMenuItem(MENU.TX)}
                          >
                            Chain Transactions
                          </Button>
                        </Stack>
                      ...
                      <AccordionPanel>
                        ...
                        >
                          <Button
                            ...
                            onClick={() => setMenuItem(MENU.VAULT)}
                          >
                            Data Vault
                          </Button>
                          <Button
                            ...
                            onClick={() => setMenuItem(MENU.STREAM)}
                          >
                            Data Streams
                          </Button>
                          <Button
                            ...
                            onClick={() => setMenuItem(MENU.TRUSTEDCOMP)}
                          >
                            Trusted Computation
                          </Button>
                        </Stack>
            ...
            <Box backgroundColor={"red1"} pl={5} w="full">
              <ChainMetaContext.Provider value={chainMeta}>
                ...
                {menuItem === MENU.BUY && (
                  <BuyData
                    key={rfKeys.buyData}
                    onRfMount={() => handleRfMount("buyData")}
                    onRefreshBalance={handleRefreshBalance}
                  />
                )}
                {menuItem === MENU.SELL && (
                ...
                {menuItem === MENU.NFT && (
                  <DataNFTs setMenuItem={setMenuItem} />
                )}
                {menuItem === MENU.NFTMINE && <MyDataNFTs />}
                {menuItem === MENU.NFTALL && <DataNFTMarketplace />}

                {menuItem === MENU.COALITION && (
                  <DataCoalitions setMenuItem={setMenuItem} />
                )}
        ...
        >
          <AlertDialogOverlay>
            <AlertDialogContent>
              ...
              <AlertDialogBody>
                Sorry the {chain} chain is currently not supported. We are
                working on it. You need to be on{" "}
