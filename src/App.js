                ...
                <Stack direction="column" spacing={4} display={[(showMobileMenu && "block") || "none", , "block"]}>
                  ...
                  <Flex direction="column" justify="space-between" minH="80vh">
                    <Stack ml="15px" spacing={4}>
                      ...
                      <Button rightIcon={<GiReceiveMoney />} w={menuButtonW} colorScheme="teal" isDisabled={menuItem === MENU.SELL} variant="solid" onClick={() => setMenuItem(MENU.SELL)}>
                        Sell Data
                      </Button>
                    </Stack>
                    ...
                    <Accordion flexGrow="1" defaultIndex={[-1]} allowToggle={true} w="230px" style={{ border: "solid 1px transparent" }}>
                      <AccordionItem>
                        ...
                        <AccordionPanel>
                          <Stack direction="column" spacing={4} align="left" mt="2" w={menuButtonW}>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.BUY} onClick={() => setMenuItem(MENU.BUY)}>
                              Buy Data
                            </Button>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.ADVERTISED} onClick={() => setMenuItem(MENU.ADVERTISED)}>
                              Advertised Data
                            </Button>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.PURCHASED} onClick={() => setMenuItem(MENU.PURCHASED)}>
                              Purchased Data
                            </Button>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.DATAPROOFS} onClick={() => setMenuItem(MENU.DATAPROOFS)}>
                      ...
                      <AccordionItem>
                        ...
                        <AccordionPanel>
                          <Stack direction="column" spacing={4} align="left" mt="2" w={menuButtonW}>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.VAULT} onClick={() => setMenuItem(MENU.VAULT)}>
                              Data Vault
                            </Button>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.STREAM} onClick={() => setMenuItem(MENU.STREAM)}>
                              Data Streams
                            </Button>
                            <Button colorScheme="teal" isDisabled={menuItem === MENU.TRUSTEDCOMP} onClick={() => setMenuItem(MENU.TRUSTEDCOMP)}>
                              Trusted Computation
                            </Button>
                          </Stack>
                        </AccordionPanel>
