      ...
      >
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            <Stack spacing="5">
              <Text fontSize="sm">
                Please select a wallet to connect to the Data DEX
              </Text>
              ...
              <Box p="15px">
                <Wrap spacing="20px" justify="space-between">
                  <Box>
                    <Button
                      isLoading={Boolean(isAuthenticatingMetamask)}
                  ...
                  <Box>
                    <Button
                      isDisabled={true}
                      isLoading={Boolean(isAuthenticatingWc)}
                      onClick={() => handleAuthenticate(WALLETS.WC)}
                      width="220px"
                      p="8"
                    >
                      <Image
                  ...
                  <Box>
                    <Button
                      ...
                      onClick={() => handleAuthenticate(WALLETS.ELROND)}
                      width="220px"
                      p="8"
                    >
                      <Image
